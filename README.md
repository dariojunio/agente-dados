...
- The agent executes Python code generated by Claude in real-time
- Avoid uploading highly sensitive data (medical records, personal identifiers, etc.)
- Data is stored only in memory during the session — not persisted to disk
- API key should be stored in `.streamlit/secrets.toml` or environment variables
